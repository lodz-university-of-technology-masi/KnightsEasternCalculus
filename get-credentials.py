...
WebDriverWait(browser, 20).until(EC.presence_of_element_located((By.CLASS_NAME, "comm-page-home")))
print("Log in successful")

browser.get('https://www.awseducate.com/student/s/launch-classroom?classroomId=a1v3m000003UkxJAAS')
WebDriverWait(browser, 20).until(EC.presence_of_element_located((By.ID, "showawsdetail"))).click()

print("Acquiring credentials...")
details = WebDriverWait(browser, 20).until(EC.visibility_of_element_located((By.ID, "modal-table-report-aws")))
